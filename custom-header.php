 ...
 * @uses wiStarter_header_style() to style front-end.
...
function wiStarter_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'wiStarter_header_style',
		'admin-head-callback'    => 'wiStarter_admin_header_style',
		'admin-preview-callback' => 'wiStarter_admin_header_image',
	);

	add_theme_support( 'custom-header', $args );
}
add_action( 'after_setup_theme', 'wiStarter_custom_header_setup' );
 ...
 * @sincewiStarter 1.0
 */
function wiStarter_header_style() {
 ...
 * @sincewiStarter 1.0
 */
function wiStarter_admin_header_style() {
?>
	<style type="text/css">
